                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Selamat Datang Di Aplikasi Kasir</h3>
                                        <h6 class="text-center font-weight-light my-4">Silahkan Masukan Nama Pengguna Dan Sandi Anda</h6>
                                </div>
                                <div class="card-body">
                                    <form method="post">
