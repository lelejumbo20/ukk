...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid px-4">
      ...
      <a href="data-penjualan-tambah.php" class="btn btn-primary mb-3">Tambah Data</a>
      <div class="card mb-4">
        <div class="card-body">
            ...
            <tbody>
              ...
              while ($row = $result->fetch_assoc()) { ?>
                <tr>
                  ...
                  <td>
                    <a href="data-penjualan-detail.php?id=<?= $row['penjualan_id'] ?>" class="btn btn-warning btn-xs mt-1"><i class="fa fa-list"></i></a>
                  </td>
                </tr>
              <?php $no++;
              }
