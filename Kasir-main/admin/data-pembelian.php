...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid px-4">
      ...
      <a href="data-pembelian-tambah.php" class="btn btn-primary mb-3">Tambah Data</a>
      <div class="card mb-4">
        <div class="card-body">
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($row['status'] == 'draft') { ?>
                      <a href="data-pembelian-edit.php?id=<?= $row['pembelian_id'] ?>" class="btn btn-danger btn-xs"><i class="fa fa-edit"></i></a>
                      <a href="" class="btn btn-link btn-xs"><i class="fa fa-trash"></i></a>
